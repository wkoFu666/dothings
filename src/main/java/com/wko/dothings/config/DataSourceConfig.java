 ...
 */
@Configuration
@MapperScan(basePackages = "com.wko.dothings.dao.local",sqlSessionFactoryRef = "localSqlSessionRef")
@MapperScan(basePackages = "com.wko.dothings.dao.remote",sqlSessionFactoryRef = "remoteSqlSessionRef")
